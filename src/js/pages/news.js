  ...
  const news = [
    {
      ...
      excerpt:
        "Setelah ketidakpastian panjang di 2025, pasar global mulai menemukan titik ekuilibrium baru. Suku bunga yang stabil memberikan ruang bagi investasi jangka panjang di sektor riil...",
      author: "Artha Editorial",
      date: "02 Mar 2026",
      image:
        "https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?auto=format&fit=crop&w=1200",
    },
    {
      type: "main",
      category: "Kilas Balik 2025",
      title:
        "Transformasi Hijau: Bagaimana 2025 Mengubah Roadmap Energi Indonesia",
      excerpt:
        "Melihat kembali pencapaian signifikan di tahun lalu, di mana investasi pada energi terbarukan melampaui target nasional sebesar 12%. Ini adalah pondasi bagi ekonomi berkelanjutan...",
      author: "Finance Desk",
      date: "28 Feb 2026",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Arus modal asing (Inflow) yang masuk ke wilayah ASEAN menunjukkan tren positif di kuartal pertama 2026, dipicu oleh ketahanan konsumsi domestik yang kuat...",
  ...
  if (mainNewsEl && sidebarNewsEl) {
    news.forEach((item) => {
      if (item.type === "main") {
        ...
        article.className =
          "group cursor-pointer border-b border-slate-200 pb-16 last:border-0";
        ...
        sideItem.className =
          "group cursor-pointer border-b border-slate-200 pb-6 last:border-0";
        sideItem.innerHTML = `
